...
REQUIRED_ENV_KEYS = (
    ...
    "CHESS_SCHEDULE_DAILY_PUZZLE_ENABLED",
    "CHESS_SCHEDULE_PROVIDER_SYNC_ENABLED",
    "CHESS_SCHEDULE_PROVIDER_SYNC_EVERY_MINUTES",
    "CHESS_PGN_IMPORT_MAX_GAMES_CAP",
    "CHESS_PROVIDER_SYNC_MAX_GAMES_CAP",
    "CHESS_PUZZLE_IMPORT_MAX_RECORDS_CAP",
    "CHESS_DISCOVERY_AUTO_ANALYZE_ENABLED",
)
