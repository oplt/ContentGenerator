...
export default function ApprovalsPage() {
 ...
 <div className="rounded-lg border p-3">
 <p className="text-xs font-medium text-muted-foreground">Callback Failures</p>
 ...
 <p className="text-xs font-medium text-muted-foreground">{approval.provider}</p>
 ...
 <span key={button} className="rounded border px-2 py-1">
 {button}
 </span>
 ))}
 </div>
